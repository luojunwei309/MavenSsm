			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form action="admin/productUpdate.html" method="post"  enctype="multipart/form-data">
							<input type="hidden" name="cid" value="${cid }"/>
							<input type="hidden" name="id" value="${product.id }"/>
							<div class="form-group">
								<label for="exampleInputPassword1">产品名字</label> <input
									name="name" value="${product.name }" type="text" class="form-control" 
									placeholder="请输入属性名">
							</div>
							<div class="form-group">
								<label for="exampleInputPassword1">产品小标题</label> <input
									name="subTitle" value="${product.subTitle }" type="text" class="form-control"
									placeholder="请输入属性名">
							</div>
							<div class="form-group">
								<label for="exampleInputPassword1">原价格</label> <input
									name="originalPrice" value="${product.originalPrice }" type="text" class="form-control"
									placeholder="请输入属性名">
							</div>
							<div class="form-group">
								<label for="exampleInputPassword1">优惠价格</label> <input
									name="promotePrice" value="${product.promotePrice }" type="text" class="form-control"
									placeholder="请输入属性名">
							</div>
							<div class="form-group">
								<label for="exampleInputPassword1">库存数量</label> <input
									name="stock" value="${product.stock }" type="text" class="form-control" 
									placeholder="请输入属性名">
							</div>
							<div class="form-group">
